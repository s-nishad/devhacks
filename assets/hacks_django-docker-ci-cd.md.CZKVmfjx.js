import{_ as i,c as a,o as n,ae as p}from"./chunks/framework.DlG2qiMf.js";const c=JSON.parse('{"title":"Django + Docker + CI/CD Deployment Guide","description":"","frontmatter":{},"headers":[],"relativePath":"hacks/django-docker-ci-cd.md","filePath":"hacks/django-docker-ci-cd.md"}'),l={name:"hacks/django-docker-ci-cd.md"};function h(e,s,t,k,E,r){return n(),a("div",null,s[0]||(s[0]=[p(`<h1 id="django-docker-ci-cd-deployment-guide" tabindex="-1">Django + Docker + CI/CD Deployment Guide <a class="header-anchor" href="#django-docker-ci-cd-deployment-guide" aria-label="Permalink to &quot;Django + Docker + CI/CD Deployment Guide&quot;">​</a></h1><p><strong>Python:</strong> 3.12 <strong>Framework:</strong> Django 5.2.7 <strong>Purpose:</strong> Deploy Django app smartly with Docker, docker-compose, and CI/CD</p><hr><h2 id="_1-project-structure" tabindex="-1">1. Project Structure <a class="header-anchor" href="#_1-project-structure" aria-label="Permalink to &quot;1. Project Structure&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>myproject/</span></span>
